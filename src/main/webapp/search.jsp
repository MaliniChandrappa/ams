...
<head>
<title>My School Education Category Bootstrap Responsive website
	...
	<header>
		<div class="container">
			<div
				...
				<div id="logo">
					<h1>
						<a href="index.html">Search Assignment</a>
					</h1>
				</div>
				<!-- //logo -->
				<!-- nav -->
				<div class="nav_w3ls ml-lg-5">
					<nav>
						...
						<ul>
							...
							<li><a href="createAssignment.jsp" class="drop-text">Create
									Assignment</a></li>
...
<div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="createAssign.ams" method="post">
	...
	<table align="center" border="2">
		...
		<list:forEach var="list" items="${list}">
			<tr>
				<td>${list.pin}</td>
				<td>${list.course}</td>
				<td>${list.topic}</td>
		...
		<button type="submit" class="btn button-style-w3">Search</button>
